...
const routes = [
  {
    ...
    components: {
      ...
      top: () => import('@/view/top/NuclearTop.vue'),
      bottom: () => import('@/view/bottom_bar/NuclearBottomBar.vue'),
  ...
  },
  {
    ...
    components: {
      ...
      bottom: () => import('@/view/bottom_bar/MeteorologicalBottomBar.vue'),
      top: () => import('@/view/top/MeteorologicalTop.vue'),
    },
  },
  {
    path: '/consequence',
    components: {
      ...
      bottom: () => import('@/view/bottom_bar/ConsequenceBottomBar.vue'),
      top: () => import('@/view/top/ConsequenceTop.vue'),
    },
  },
  {
    path: '/evacuate',
